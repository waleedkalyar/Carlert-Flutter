...
class PreferenceManager {
  ...
  Future<void> saveSelectedVehicleInPref(DeviceModel? deviceModel) async {
    await prefs.setString(SELECTED_VEHICLE, jsonEncode(deviceModel!.toJson()));
  }
  ...
  DeviceModel? getSelectedVehicle() {
    return prefs
        .getCustomValue(SELECTED_VEHICLE,
            defaultValue: null,
            adapter: JsonAdapter(
              deserializer: (value) =>
                  DeviceModel.fromJson(value as Map<String, dynamic>),
            ))
        .getValue();
  }
  ...
  Stream<DeviceModel?> streamCurrentDevice() => prefs
      .getCustomValue(SELECTED_VEHICLE,
          defaultValue: null,
          adapter: JsonAdapter(
            deserializer: (value) =>
