...
class ItemCompletedServiceRequest extends StatelessWidget {
  const ItemCompletedServiceRequest({super.key});
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Completed", style: Theme.of(context).primaryTextTheme.titleMedium?.copyWith(color: appWhite),)),),
                ),
              ),
            ),
          ],),
