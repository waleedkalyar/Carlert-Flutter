...
import 'package:carlet_flutter/src/ui/screens/main/home/pages/live/widgets/moving_markers_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: BlocListener<LiveMarkersBloc, LiveMarkersState>(
          ...
          child: Padding(padding: 0.allPadding, child: const MovingMarkersView()),
        ));
  }
}
